...
if st.button("📄 Generate Estimate", type="primary"):
    ...
    try:
        ...
        if len(village_repairs) > 0:
            ...
            if parent_key:
                ...
                if parent_key:
                    ...
                    # -----------------------------------------
                    # FIRST: POPULATE MAIN REPAIR DATA
                    # -----------------------------------------
                    ...
                    # -----------------------------------------
                    # SECOND: POPULATE REPEAT DETAILS
                    # -----------------------------------------
        ...
        # =================================================
        # IMPORTANT
        # SET ALL REPEAT FORMULAS LAST
        # =================================================
        #
        # These MUST come AFTER all populate_sheet()
        # operations because populate_sheet() can overwrite
        # cells in Input Data Sheet-T.
        #
        # =================================================
